 ...
 */
export declare function DoudizhuCardId(value: string): DoudizhuCardId;
...
export type DoudizhuCombinationKind = 'single' | 'pair' | 'triple' | 'triple-single' | 'triple-pair' | 'straight' | 'pair-straight' | 'airplane' | 'airplane-single' | 'airplane-pair' | 'four-two-single' | 'four-two-pair' | 'bomb' | 'rocket';
...
export interface DoudizhuState {
    ...
    readonly history: readonly (DoudizhuBidRecord | DoudizhuPlayRecord | {
        readonly seat: DoudizhuSeat;
        readonly pass: true;
    })[];
