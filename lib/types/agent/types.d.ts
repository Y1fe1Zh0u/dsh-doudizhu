...
export declare const LAN_GAME_ACTION_TOOL = "submit_lan_game_action";
...
export type LanGameAgentErrorCode = 'LAN_GAME_INVALID_ARGUMENT' | 'LAN_GAME_NOT_FOUND' | 'LAN_GAME_PARENT_MISMATCH' | 'LAN_GAME_DECISION_PENDING' | 'LAN_GAME_DECISION_MISMATCH' | 'LAN_GAME_DECISION_TIMEOUT';
