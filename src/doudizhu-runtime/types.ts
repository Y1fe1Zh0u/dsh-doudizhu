...
export type DoudizhuTableSnapshot =
  | ({ readonly game: 'doudizhu'; readonly status: 'running' | 'round-finished' | 'finished' } & DoudizhuMatchPublicView)
  | { readonly game: 'doudizhu'; readonly status: 'failed'; readonly error: string }
