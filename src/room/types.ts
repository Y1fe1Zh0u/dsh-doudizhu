 ...
 */
export function LanRoomId(value: string): LanRoomId {
  return value as LanRoomId
}
 ...
 */
export function LanMemberId(value: string): LanMemberId {
  return value as LanMemberId
}
 ...
 */
export function LanRoomCode(value: string): LanRoomCode {
  return value as LanRoomCode
}
